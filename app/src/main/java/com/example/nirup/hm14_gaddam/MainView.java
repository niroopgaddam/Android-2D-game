...
public class MainView extends SurfaceView implements SurfaceHolder.Callback {
  ...
  public   static MediaPlayer gameOnsound;
    ...
    public MainView (Context context) {
        ...
        Assets.sound_squish = Assets.soundPool.load(context, R.raw.squish1_food, 1);
        Assets.sound_squish1 = Assets.soundPool.load(context, R.raw.squish2, 1);
        Assets.sound_squish2 = Assets.soundPool.load(context, R.raw.squish3, 1);
        Assets.sound_squish_big = Assets.soundPool.load(context, R.raw.bigsquish, 1);
        Assets.sound_thump = Assets.soundPool.load(context, R.raw.squish3_touch, 1);
        Assets.sound_gameover = Assets.soundPool.load(context, R.raw.game_over, 1);
        gameOnsound = MediaPlayer.create(context,R.raw.gameon);//Music for total App//
        gameOver = MediaPlayer.create(context,R.raw.game_over);//Completed
        gameOnsound.start();
